...
public class Validator {
     ...
     * 正则表达式：验证短信验证码
     */
    private static final String REGEX_MESSAGE_CODE ="^[0-9]{4,6}$";
    /**
     * 正则表达式：验证邮箱
     */
     ...
     * @return 校验通过返回true，否则返回false
     */
    public static boolean isMessageCode(String mobile) {
        return Pattern.matches(REGEX_MESSAGE_CODE, mobile);
    }
