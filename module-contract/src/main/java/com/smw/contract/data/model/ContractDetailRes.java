...
public class ContractDetailRes extends BaseBean implements Serializable {
    ...
    private int enable;
    private int status;
    private ArrayList<SignFileBean> files;
    private ArrayList<SignUserBean> users;
    ...
    public ArrayList<SignFileBean> getFiles() {
        return files;
    }

    public void setFiles(ArrayList<SignFileBean> files) {
        this.files = files;
    }

    public ArrayList<SignUserBean> getUsers() {
        return users;
    }

    public void setUsers(ArrayList<SignUserBean> users) {
        this.users = users;
    }
}
