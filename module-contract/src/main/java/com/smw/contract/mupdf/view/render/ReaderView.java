...
import com.smw.contract.mupdf.view.page.MuPDFPageAdapter;
...
public class ReaderView
    ...
    /**
     * When advancing down the page, we want to advance by about      90% of a screenful. But we'd be happy to advance by between      80% and 95% if it means we hit the bottom in a whole number      of steps.
     * @param screenHeight
     * @param max
     * @return
     */
