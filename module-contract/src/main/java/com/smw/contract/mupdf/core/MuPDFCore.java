package com.smw.contract.mupdf.core;
...
import com.smw.contract.mupdf.view.page.PassClickResult;
import com.smw.contract.mupdf.view.page.PassClickResultChoice;
import com.smw.contract.mupdf.view.page.PassClickResultSignature;
import com.smw.contract.mupdf.view.page.PassClickResultText;
import com.smw.contract.mupdf.view.page.TextChar;
import com.smw.contract.mupdf.view.page.TextWord;
import com.smw.contract.mupdf.view.page.WidgetType;
import com.smw.contract.mupdf.view.render.OutlineItem;
import com.smw.contract.mupdf.view.render.Separation;
...
public class MuPDFCore
{
	...
	static {
		...
		Log.i("MuPDFCore", "static initializer: loadLibrary");
	...
	public MuPDFCore(Context context, String filename) throws Exception
	{
		...
		if (globals == 0)
		{
			throw new Exception(String.format("无法打开文件路径", filename));
		}
